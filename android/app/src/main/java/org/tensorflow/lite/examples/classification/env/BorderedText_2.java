...
public class BorderedText_2 {
   ...
   */
  public BorderedText_2(final float textSize) {
   ...
   * @param textSize text size in pixels
   */
  public BorderedText_2(final int interiorColor, final int exteriorColor, final float textSize) {
